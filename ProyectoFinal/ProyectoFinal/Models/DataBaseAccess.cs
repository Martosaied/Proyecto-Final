...
namespace ProyectoFinal.Models
{
    public class DataBaseAccess : DbContext
    {
        ...
        public static MySqlCommand GenerateSqlCommand(string cmdText)
        {
            ...
            MySqlConnection conectar = new MySqlConnection("Database=localdb;Server=127.0.0.1;Port=50006;User Id=azure;Password=6#vWHD_$; Allow Zero Datetime=True;");
        ...
        {
            MySqlConnection conectar = new MySqlConnection("Database=localdb;Server=127.0.0.1;Port=50006;;User Id=azure;Password=6#vWHD_$");
            conectar.Open();
            return conectar;
        }
